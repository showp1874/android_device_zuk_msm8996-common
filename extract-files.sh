...
# Hax /firmware/image to /vendor/firmware_mnt to delete the outdated rootdir symlinks
...
# Hax /bt_firmware to /vendor/btfw to delete the outdated rootdir symlinks
